...
/*   Updated: 2021/01/25 23:42:19 by schang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!**line && (type == TYPE_REDIRECT_OUTPUT
		|| type == TYPE_REDIRECT_INPUT || type == TYPE_DOUBLE_REDIRECT
		|| type == TYPE_PIPE || type == TYPE_SEMICOLON))
		return (SYNTAX_ERROR);
